...
class ClientSidePage1 extends React.Component {
	...
	componentDidMount(){
		fetch('http://localhost:3000/api/player/sora', {
			method: "GET",
			headers: {
		    		...
		    		{(!playerData)
		    			...
		    			: <span>
							...
							<Button className="mt-2" block>
					  			<Link href="/rendering-types/client-side/page-2">
			  						<a style={{color: "inherit"}}>Ver el segundo jugador</a>
			  					</Link>
				          	</Button>
				          	<Button className="mt-2" block>
...
export default ClientSidePage1;