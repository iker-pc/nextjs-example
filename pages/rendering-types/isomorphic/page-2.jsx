...
class IsomorphicPage2 extends React.Component {
		    			...
		    			: playerData 
			    			&& <span>
								...
								<Button className="mt-2" block>
						  			<Link href="/rendering-types/isomorphic/page-1">
				  						<a style={{color: "inherit"}} onClick={() => this.setState({ loading: true })}>Ver el primer jugador</a>
				  					</Link>
					          	</Button>
					          	<Button className="mt-2" block>
...
export default IsomorphicPage2;